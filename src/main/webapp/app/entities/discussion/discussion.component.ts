...
export class DiscussionComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.discussionService.query({
            ...
            (res: HttpResponse<Discussion[]>) => this.onSuccess(res.body, res.headers),
    ...
    registerChangeInDiscussions() {
        this.eventSubscriber = this.eventManager.subscribe('discussionListModification', (response) => this.reset());
    }
