...
export class JourneyComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.journeyService.query({
            ...
            (res: HttpResponse<Journey[]>) => this.onSuccess(res.body, res.headers),
    ...
    registerChangeInJourneys() {
        this.eventSubscriber = this.eventManager.subscribe('journeyListModification', (response) => this.reset());
    }
