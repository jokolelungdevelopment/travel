...
public class TransactionResourceIntTest {
    ...
    private static final String DEFAULT_DELIVERYTO = "AAAAAAAAAA";
    private static final String UPDATED_DELIVERYTO = "BBBBBBBBBB";
    ...
    public void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getRequestid()).isEqualTo(DEFAULT_REQUESTID);
        assertThat(testTransaction.getPreorderid()).isEqualTo(DEFAULT_PREORDERID);
        assertThat(testTransaction.getDeliveryto()).isEqualTo(DEFAULT_DELIVERYTO);
        assertThat(testTransaction.getQty()).isEqualTo(DEFAULT_QTY);
    ...
    public void getAllTransactions() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].deliveryto").value(hasItem(DEFAULT_DELIVERYTO.toString())))
    ...
    public void getTransaction() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions/{id}", transaction.getId()))
            ...
            .andExpect(jsonPath("$.deliveryto").value(DEFAULT_DELIVERYTO.toString()))
    ...
    public void updateTransaction() throws Exception {
        ...
        Transaction testTransaction = transactionList.get(transactionList.size() - 1);
        assertThat(testTransaction.getRequestid()).isEqualTo(UPDATED_REQUESTID);
        assertThat(testTransaction.getPreorderid()).isEqualTo(UPDATED_PREORDERID);
        assertThat(testTransaction.getDeliveryto()).isEqualTo(UPDATED_DELIVERYTO);
        assertThat(testTransaction.getQty()).isEqualTo(UPDATED_QTY);
