...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "productname":"SAMPLE_TEXT", "description":null, "brand":"SAMPLE_TEXT", "url":"SAMPLE_TEXT", "quantity":"SAMPLE_TEXT", "spesialtreatment":null, "fragile":null, "productweight":null, "productsize":null, "productprice":null, "pruducttip":null, "additionalcharge":null, "total":null}""")).asJSON
            .check(status.is(201))
